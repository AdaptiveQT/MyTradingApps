//+------------------------------------------------------------------+
//|                 RetailBeastFX_Premium_Compliance.mq5              |
//|                       Copyright 2025, RetailBeastFX              |
//|       COMPLIANCE MODE - Eligibility Validators ONLY              |
//|       NOT trade signals. FX Majors + Gold ONLY.                  |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, RetailBeastFX"
#property link      "https://retailbeastfx.com"
#property version   "9.00"
#property description "RetailBeastFX COMPLIANCE - Eligibility validators ONLY. NOT signals."
#property strict
...
//--- Signal Arrows
#property indicator_label7  "Bullish Eligibility"
#property indicator_type7   DRAW_ARROW
#property indicator_color7  C'0,255,150'
#property indicator_style7  STYLE_SOLID
#property indicator_width7  3

#property indicator_label8  "Bearish Eligibility"
...
input bool InpShowKillzones = true;          // Show Killzone Boxes (Locked 02-05/08-11 ET)
...
input bool InpShowKZPivots = false;          // Show Session Pivots
...
input double InpBBDeviation = 1.0;           // BB Deviation (LOCKED to 1.0)
...
input bool InpShowOrderBlocks = true;        // Show OB Zones (Optional Visual, Not Signal)
input bool InpShowBOS = false;               // Show Break of Structure (COMPLIANCE: Off)
input bool InpShowCHoCH = false;             // Show Change of Character (COMPLIANCE: Off)
input int InpSwingStrength = 3;              // Swing Detection Strength (2-10)
input int InpMaxOBCount = 2;                 // Max OBs (2 like TradingView)
...
input bool InpShowHTF = false;                // Enable HTF Analysis (COMPLIANCE: Off)
...
int OnInit()
{
   ...
   PlotIndexSetInteger(6, PLOT_ARROW, 159);  // Circle (eligibility)
   PlotIndexSetInteger(7, PLOT_ARROW, 159);  // Circle (eligibility)
